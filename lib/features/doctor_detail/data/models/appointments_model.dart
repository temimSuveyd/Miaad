...
class AppointmentsModel extends Equatable {
  ...
  @override
  String toString() {
    return 'AppointmentsModel(id: $id, userId: $userId, doctorId: $doctorId, date: $date, time: $time, status: $status, rescheduledBy: $rescheduledBy, cancelledBy: $cancelledBy, notes: $notes, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
}
