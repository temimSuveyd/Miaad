...
class BookAppointmentState extends Equatable {
  ...
  // حالات خاصة للسلوتس
  final bool hasNoSlotsAvailable;
  final bool hasNoWorkingHours;
  ...
  const BookAppointmentState({
    ...
    this.successMessage,
    this.hasNoSlotsAvailable = false,
    this.hasNoWorkingHours = false,
  ...
  BookAppointmentState copyWith({
    ...
    bool? hasNoSlotsAvailable,
    bool? hasNoWorkingHours,
    ...
    return BookAppointmentState(
      ...
      hasNoSlotsAvailable: hasNoSlotsAvailable ?? this.hasNoSlotsAvailable,
      hasNoWorkingHours: hasNoWorkingHours ?? this.hasNoWorkingHours,
  ...
  /// التحقق من وجود سلوتس متاحة
  bool get hasAvailableSlots => availableSlots.isNotEmpty;

  /// التحقق من عدم وجود سلوتس متاحة
  bool get noSlotsAvailable => hasNoSlotsAvailable || (!hasAvailableSlots && !isLoading);

  /// التحقق من عدم وجود ساعات عمل
  bool get noWorkingHours => hasNoWorkingHours;

  /// الحصول على رسالة عدم توفر السلوتس
  String get noSlotsMessage {
    if (slotsErrorMessage != null) {
      return slotsErrorMessage!;
    }
    if (hasNoWorkingHours) {
      return 'الطبيب لم يحدد ساعات العمل بعد';
    }
    if (hasNoSlotsAvailable) {
      return 'لا توجد أوقات متاحة للحجز حالياً';
    }
