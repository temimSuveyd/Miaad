...
import 'package:doctorbooking/features/appointments/presentation/book_appointment/widgets/doctor_booking_bottom_bar.dart';
import 'package:doctorbooking/features/appointments/presentation/book_appointment/widgets/weekly_schedule.dart';
      ...
      child: Scaffold(
        ...
        bottomNavigationBar:
            BlocBuilder<BookAppointmentCubit, BookAppointmentState>(
              builder: (context, state) {
                // Tatil günü ise bottom bar gösterme
                if (state.isTodayHoliday) {
